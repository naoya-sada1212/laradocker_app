                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('register') }}" enctype="multipart/form-data">
                        ...
                        <!-- <div class="form-group row">
                          ...
                          <div class="col-md-6">
                            <input type="file" name="user_image" class="@error ('user_image') is-invalid @enderror" name="user_image" value="{{ old('user_image') }}" required autocomplete="user_image" autofocus>
